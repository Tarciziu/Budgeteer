...
public struct OnboardingAccountScreen: View {
  ...
  /// Createa a new `OnboardingAccountScreen`.
  /// - Parameter viewModel: The view model assciated with the screen.
  ...
  private var depotNameInputField: some View {
    InputField(
      text: $viewModel.name,
  ...
  private var balanceInputField: some View {
    InputField(
